...
;;; Test1
(framework-check 45 (count-pairs 10 (lambda (x y) #t)))

;;; Test2
(framework-check 861 (count-pairs 42 (lambda (x y) #t)))

;;; Test3
(framework-check 20 (count-pairs 10 (lambda (x y) (even? (+ x y)))))

;;; Test4
(framework-check 25 (count-pairs 10 (lambda (x y) (odd? (+ x y)))))
