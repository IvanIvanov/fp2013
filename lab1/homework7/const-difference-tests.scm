...
;;; Test1
(framework-check #t (const-difference '(1 2 3) '(1 2 3)))

;;; Test2
(framework-check #t (const-difference '(1 2 3) '(11 12 13)))

;;; Test3
(framework-check #f (const-difference '(1 2 3) '(11 12 14)))
