...
;;; Test1
(framework-check 33 (sum-multiples-3-5 10))

;;; Test2
(framework-check 450 (sum-multiples-3-5 42))

;;; Test3
(framework-check 2418 (sum-multiples-3-5 100))

;;; Test4
(framework-check 234168 (sum-multiples-3-5 1000))
