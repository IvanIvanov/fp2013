...
;;; Test1
(framework-check 15 (sum-of-cool 1 10))

;;; Test2
(framework-check 41 (sum-of-cool 13 42))

;;; Test3
(framework-check 1138 (sum-of-cool 1 1000))

;;; Test4
(framework-check 1681 (sum-of-cool 1000 2000))
