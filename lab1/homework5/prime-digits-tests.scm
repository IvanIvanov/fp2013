...
;;; Test1
(framework-check '(2 3 5 7) (prime-digits 1234567890))

;;; Test2
(framework-check '(7 5 3 2) (prime-digits 987654321))

;;; Test3
(framework-check '(2) (prime-digits 42))

;;; Test4
(framework-check '() (prime-digits 0))
